...
namespace UCDASearches.WebMVC.Controllers
{
    ...
    public class PreviousSearchesController : Controller
    {
        ...
        public async Task<IActionResult> Index(PreviousSearchesViewModel model)
        {
            ...
            var sql = @"SELECT TOP 100 RequestID, UID, VIN, Time_Stamp, Account, Operator, AutoCheck, Lien, History, OOPS, ExcaDate, EXCA, IRE, Carfax, CPIC, CPICTime, CAMVAP, LNONpath, LNONcompleted
